...
// func (topic *topic_receiver) BindWithRoutingKey(routingKey string, exchangeName string) (err error) {
...
// func (topic *topic_receiver) Receive(ctx context.Context) <-chan []byte {

// 	msgs, err := topic.channel.Consume(

// 		topic.queue.Name, //Queue
// 		"",               // consumer
// 		true,             // auto ack
// 		false,            // exclusive
// 		false,            // no local
